...
final class StripeBillingService
{
    public static function createCheckoutSession(string $empresaId, ?string $requestedPlanCode = null, ?string $requestedPeriod = null, bool $tenantCheckout = false): string
    {
        ...
        $session = \Stripe\Checkout\Session::create([
            ...
            'success_url' => trusted_request_app_base_url() . '/index.php?route=stripe-checkout-success&source=' . ($tenantCheckout ? 'tenant' : 'platform') . '&session_id={CHECKOUT_SESSION_ID}',
            'cancel_url' => trusted_request_app_base_url() . '/index.php?route=stripe-checkout-cancel&source=' . ($tenantCheckout ? 'tenant' : 'platform') . '&empresa_id=' . rawurlencode((string) $empresa['id']),
