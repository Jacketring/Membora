...
<head>
  ...
  <title>Factura <?= e($invoice['invoice_code']) ?> - Membora CRM</title>
  ...
  <article class="invoice">
    <header class="invoice-header">
      ...
      <div class="invoice-meta">
        ...
        <p><b><?= e($invoice['invoice_code']) ?></b></p>
    ...
    <section class="summary-grid">
      ...
      <div class="party">
        <span>Cliente</span>
        <h2><?= e($invoice['empresa_name']) ?></h2>
        <p><?= e($invoice['contact_email'] ?: 'Sin email de contacto') ?></p>
        <p>Plan: <?= e($planLabel) ?></p>
        <p>Estado: <?= e(platform_invoice_status_label($invoice['status'])) ?></p>
      </div>
    </section>
    ...
    <table aria-label="Detalle de factura">
      ...
      <tbody>
        <tr>
          <td><strong><?= e($invoice['concept']) ?></strong></td>
          <td>
    ...
    <section class="totals" aria-label="Totales">
      <table>
        ...
        <tr>
          <td>IVA <?= e(number_format((float) $invoice['tax_rate'], 2, ',', '.')) ?>%</td>
          <td class="amount"><?= e(money_amount($invoice['tax_amount'])) ?></td>
        </tr>
        <tr>
          <td>Total factura</td>
    ...
    <section class="notes">
      ...
      <p>Documento generado desde Admin CRM. Los datos fiscales del emisor deben completarse antes de un uso comercial real.</p>
    </section>
