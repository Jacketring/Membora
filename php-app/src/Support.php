...
function audit_action_label(?string $action): string
{
    ...
    $labels = [
        ...
        'create_user' => 'Usuarios - creacion',
        'update_user' => 'Usuarios - modificacion o baja',
        'delete_user' => 'Usuarios - eliminacion',
        ...
        'create_member' => 'Socios - creacion',
        'update_member' => 'Socios - modificacion',
        'delete_member' => 'Socios - eliminacion',
        'create_membership_plan' => 'Membresias - creacion',
        'update_membership_plan' => 'Membresias - modificacion',
        'delete_membership_plan' => 'Membresias - eliminacion',
        'create_payment' => 'Creacion de pago',
        'update_payment' => 'Actualizacion de pago',
        'delete_payment' => 'Eliminacion de pago',
        'create_checkin' => 'Check-ins - creacion',
        'delete_checkin' => 'Check-ins - eliminacion',
        'update_risk_alert_status' => 'Alertas - cambio de estado',
        'save_billing_integration' => 'Configuracion de facturacion',
        'sync_billing_integration' => 'Sincronizacion de facturacion',
        'create_class_type' => 'Clases - creacion de tipo',
        'create_class_session' => 'Clases - creacion',
        'update_class_session' => 'Clases - modificacion',
        'delete_class_session' => 'Clases - eliminacion',
        'create_reservation' => 'Creacion de reserva',
        'update_reservation_status' => 'Cambio de reserva',
        'create_task' => 'Tareas - creacion',
        'update_task' => 'Tareas - modificacion',
        'update_task_status' => 'Tareas - cambio de estado',
        'delete_task' => 'Tareas - eliminacion',
        'view_audit' => 'Auditoria - consulta',
